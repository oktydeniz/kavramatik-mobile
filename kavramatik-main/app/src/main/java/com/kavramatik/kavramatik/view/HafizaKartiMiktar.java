...
public class HafizaKartiMiktar extends Fragment {

    public HafizaKartiMiktarBinding binding;
    int[] cardsArray = {101, 102, 201, 202};
    //int image101, image102, image201, image202;
    int firstCard, secondCard;
    int clickedFirst, clickedSecond;
    int cardNumber = 1;
    public QuantityViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = HafizaKartiMiktarBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
            ...
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getQuantityOneImage());
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(tur == 2){
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getQuantityOneImage());
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getQuantityOneImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getQuantityOneImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getQuantityOneImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getQuantityOneImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getQuantityOneImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getQuantityOneImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getQuantityOneImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getQuantityOneImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getQuantityOneImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getQuantityOneImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getQuantityOneImage());
                        Bitmap image8 = Base64Util.decodeToBitmap(model.get(sayilar.get(7)).getQuantityOneImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
