...
public class HafizaKartiSayi extends Fragment {

    public HafizaKartiSayiBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = HafizaKartiSayiBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
            Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getNumberImage());
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getNumberImage());
            binding.ipucu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                    imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                    imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                    imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                    geriSayim();
                }
            });
        });
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(tur == 2){
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getNumberImage());
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getNumberImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getNumberImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getNumberImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getNumberImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getNumberImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                ...
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getNumberImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getNumberImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                ...
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getNumberImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getNumberImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                ...
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 120, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(12).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                imageViews.get(13).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getNumberImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getNumberImage());
                        Bitmap image8 = Base64Util.decodeToBitmap(model.get(sayilar.get(7)).getNumberImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                ...
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 120, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 120, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
                                imageViews.get(12).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
                                imageViews.get(13).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
                                imageViews.get(14).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 120, false));
                                imageViews.get(15).setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 120, false));
                                geriSayim();
                            }
                        });
                    });
    ...
    private void doStuff(ImageView iv, int card){
        viewModel.numberModel.observe(getViewLifecycleOwner(), model -> {
            ...
            if(cardsArray[card] == 101){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 120, false));
            }
            else if(cardsArray[card] == 102){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 120, false));
            }
            else if(cardsArray[card] == 103){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 120, false));
            }
            else if(cardsArray[card] == 104){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 120, false));
            }
            else if(cardsArray[card] == 105){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 120, false));
            }
            else if(cardsArray[card] == 106){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 120, false));
            }
            else if(cardsArray[card] == 107){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 120, false));
            }
            else if(cardsArray[card] == 108){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 120, false));
            }
