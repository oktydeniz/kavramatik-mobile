...
import com.kavramatik.kavramatik.databinding.HafizaKartiDuyguBinding;
...
public class HafizaKartiDuygu extends Fragment {

    public HafizaKartiDuyguBinding binding;
    int[] cardsArray = {101, 102, 201, 202};
    //int image101, image102, image201, image202;
    int firstCard, secondCard;
    int clickedFirst, clickedSecond;
    int cardNumber = 1;
    public EmotionViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = HafizaKartiDuyguBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
            Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getEmotionImage());
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getEmotionImage());
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(tur == 2){
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getEmotionImage());
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getEmotionImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getEmotionImage());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getEmotionImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getEmotionImage());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getEmotionImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getEmotionImage());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getEmotionImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getEmotionImage());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getEmotionImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getEmotionImage());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getEmotionImage());
                        Bitmap image8 = Base64Util.decodeToBitmap(model.get(sayilar.get(7)).getEmotionImage());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
