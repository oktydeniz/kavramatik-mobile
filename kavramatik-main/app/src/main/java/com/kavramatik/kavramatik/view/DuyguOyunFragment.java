...
import com.kavramatik.kavramatik.databinding.FragmentOyunDuyguBinding;
...
public class DuyguOyunFragment extends Fragment {

    private FragmentOyunDuyguBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOyunDuyguBinding.inflate(inflater, container, false);
    ...
    public void observeData() {
        ...
        viewModel.mutableLiveData.observe(getViewLifecycleOwner(), model -> {
            Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar[0]).getEmotionImage());
            binding.ustSayi.setImageBitmap(image1);
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar[0]).getEmotionImage());
            binding.solSayi.setImageBitmap(image2);
            Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar[1]).getEmotionImage());
            binding.ortaSayi.setImageBitmap(image3);
            Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar[2]).getEmotionImage());
    ...
    private void rastgele() {
        while(true){
            int sayi1 = rastgele.nextInt(20);
            int sayi2 = rastgele.nextInt(20);
            int sayi3 = rastgele.nextInt(20);
