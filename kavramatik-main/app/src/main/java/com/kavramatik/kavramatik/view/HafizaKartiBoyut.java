...
import com.kavramatik.kavramatik.databinding.HafizaKartiBoyutBinding;
import com.kavramatik.kavramatik.databinding.HafizaKartiRenkBinding;
...
public class HafizaKartiBoyut extends Fragment {

    public HafizaKartiBoyutBinding binding;
    int[] cardsArray = {101, 102, 201, 202};
    //int image101, image102, image201, image202;
    int firstCard, secondCard;
    int clickedFirst, clickedSecond;
    int cardNumber = 1;
    public DimensionViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = HafizaKartiBoyutBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
            Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getImageOne());
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getImageOne());
            binding.ipucu.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                    imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                    imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                    imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                    geriSayim();
                }
            });
        });
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(tur == 2){
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getImageOne());
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getImageOne());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getImageOne());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getImageOne());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(1).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getImageOne());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getImageOne());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                ...
                                imageViews.get(2).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getImageOne());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getImageOne());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                ...
                                imageViews.get(3).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getImageOne());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getImageOne());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                ...
                                imageViews.get(4).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 130, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(12).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                imageViews.get(13).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
                    ...
                    viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getImageOne());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getImageOne());
                        Bitmap image8 = Base64Util.decodeToBitmap(model.get(sayilar.get(7)).getImageOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                ...
                                imageViews.get(5).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                imageViews.get(6).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 130, false));
                                imageViews.get(7).setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 130, false));
                                imageViews.get(8).setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
                                imageViews.get(9).setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
                                imageViews.get(10).setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
                                imageViews.get(11).setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
                                imageViews.get(12).setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
                                imageViews.get(13).setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
                                imageViews.get(14).setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 130, false));
                                imageViews.get(15).setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 130, false));
                                geriSayim();
                            }
                        });
                    });
    ...
    private void doStuff(ImageView iv, int card){
        viewModel.listMutableLiveData.observe(getViewLifecycleOwner(), model -> {
            ...
            if(cardsArray[card] == 101){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image1, 100, 130, false));
            }
            else if(cardsArray[card] == 102){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image2, 100, 130, false));
            }
            else if(cardsArray[card] == 103){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image3, 100, 130, false));
            }
            else if(cardsArray[card] == 104){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image4, 100, 130, false));
            }
            else if(cardsArray[card] == 105){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image5, 100, 130, false));
            }
            else if(cardsArray[card] == 106){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image6, 100, 130, false));
            }
            else if(cardsArray[card] == 107){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image7, 100, 130, false));
            }
            else if(cardsArray[card] == 108){
                iv.setImageBitmap(Bitmap.createScaledBitmap(image8, 100, 130, false));
            }
