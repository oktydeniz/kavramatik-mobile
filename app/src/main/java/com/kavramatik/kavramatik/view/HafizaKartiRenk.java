...
public class HafizaKartiRenk extends Fragment {

    public HafizaKartiRenkBinding binding;
    int[] cardsArray = {101, 102, 201, 202};
    //int image101, image102, image201, image202;
    int firstCard, secondCard;
    int clickedFirst, clickedSecond;
    int cardNumber = 1;
    public ColorMatchViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = HafizaKartiRenkBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
            ...
            Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getColorOne());
            ...
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                if(tur == 2){
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        Bitmap image1 = Base64Util.decodeToBitmap(model.get(sayilar.get(0)).getColorOne());
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getColorOne());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image2 = Base64Util.decodeToBitmap(model.get(sayilar.get(1)).getColorOne());
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getColorOne());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image3 = Base64Util.decodeToBitmap(model.get(sayilar.get(2)).getColorOne());
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getColorOne());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image4 = Base64Util.decodeToBitmap(model.get(sayilar.get(3)).getColorOne());
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getColorOne());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image5 = Base64Util.decodeToBitmap(model.get(sayilar.get(4)).getColorOne());
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getColorOne());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
                    ...
                    viewModel.mutableLiveDataColors.observe(getViewLifecycleOwner(), model -> {
                        ...
                        Bitmap image6 = Base64Util.decodeToBitmap(model.get(sayilar.get(5)).getColorOne());
                        Bitmap image7 = Base64Util.decodeToBitmap(model.get(sayilar.get(6)).getColorOne());
                        Bitmap image8 = Base64Util.decodeToBitmap(model.get(sayilar.get(7)).getColorOne());
                        binding.ipucu.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                imageViews.get(0).setImageBitmap(Bitmap.createScaledBitmap(image1, 175, 175, false));
